...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col">
            <div class="card">
                <div class="card-header">{{ __('Nuevo Tramo') }}
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('refhighways.store')}}" method="post">
                        @csrf
                        <div class="form-group row">
                            <label for="highway" class="col-sm-2 col-form-label">Tramo</label>
                            <div class="col-sm-10">
                              <input type="text" class="form-control" name="highway" id="highway" value="{{ old('highway') }}">
                            </div>
                        </div>
