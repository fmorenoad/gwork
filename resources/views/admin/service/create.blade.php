        ...
        <div class="col">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('services.store', ['contract' => $contract])}}" method="post">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              <input type="text" class="form-control" name="variable_cost" id="variable_cost" value="{{ old('variable_cost') }}" required>
                            </div>
                        </div>
